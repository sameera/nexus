...
category: quality
tools: read_file, write_file, glob, search_file_content, run_shell_command
model: sonnet
---
...
```bash
python <project-root>/gemini/.gemini/skills/nxs-qa/scripts/nxs_gh_create_qa_issues.py /tmp/qa-specs-<epic>.json
```

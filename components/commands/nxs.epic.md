...
- **Nothing committed to `.nexus/queue/`**: the epic lives on GitHub issues, and the queue entry is created at close. The `epic.md` draft stayed in session scratch. This holds in discovery mode too: a consumed discovery folder is left exactly as it was found.

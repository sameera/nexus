...
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| `nxs.init.md`            | **Modify** — cut the generated `docs/system/README.md` navigation index (§1). Keep stack/standards/CLAUDE.md edits. Scaffold the G1 `docs/system/delivery/lessons/` folder (with a README documenting the one-file-per-lesson convention) and the G4 NFR-budget home under `docs/system/standards/` (C3/C4).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | §1       |

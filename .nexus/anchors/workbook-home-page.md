...
- `libs/portable-tools/src/workbook-render.ts` — the home page: its reserved name, one list item per slice, the marks, and the dependency links to in-page anchors (#592)

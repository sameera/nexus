...
- `libs/delivery-config/src/nexus-gh-cli.ts` — the source of the second declared binary, now bundled into the staged tree like the first.
- `libs/gh-toolkit/bin/nexus-gh` — no longer a declared binary; it ships as the retained entry the second toolkit delegates two capabilities to.

...
- `.claude/commands/nxs.hld.md` — the high-level-design stage: files the decision record as an approvable sub-issue of the epic (with the --from import and --revise revision flow) and drives the needs-design/in-progress label lifecycle.

...
- `libs/portable-tools/src/environment-guard.ts` — counts the installed component sets by the same nxs-namespace predicate the deploy mirror owns its files by, and reports a duplicate this CLI resolves.

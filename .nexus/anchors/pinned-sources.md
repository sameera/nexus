...
- `libs/portable-tools/src/source-pinning.ts` — the pinning step: learner-slice targeting, pin-together refusal, kept sources, and the checks on section, refuted alternative and exemplar
- `libs/portable-tools/src/source-pinning.spec.ts` — pins the handoff and scaffold exclusions, the unapproved-record no-op, the kept sources, and each refusal

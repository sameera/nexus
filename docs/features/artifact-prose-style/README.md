...
# Artifact Prose Style

Plain-language rules for every human-facing Nexus artifact, enforced without keeping the rulebook resident in the authoring context.

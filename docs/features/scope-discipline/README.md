...
Keeping planning artifacts to the scope someone actually asked for.
...
- **The Razor Check Reads a Decision Record as a Decision Record** — [#759](https://github.com/sameera/nexus/issues/759)

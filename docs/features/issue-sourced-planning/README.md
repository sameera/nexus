...
Planning surfaces live on GitHub issues rather than committed files — the backlog included.
...
- **Planning Drafts Live in the Repository's Scratch Folder** — [#638](https://github.com/sameera/nexus/issues/638)
